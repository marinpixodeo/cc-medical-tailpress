...
<div id="content" class="site-content overflow-hidden">
    <section class="section-mv relative">
        <div class="w-full sm:w-[560px] absolute bottom-8 md:bottom-[45px] px-[20px] md:px-[0] left-1/2 md:left-[55.8%] transform -translate-x-1/2">
            <p data-aos="fade-up" class="absolute w-[200px] md:w-[296px] right-[15px] sm:right-0 md:right-[-60px] xl:right-[-148px] top-[-120px] sm:top-[-90px] md:top-[-180px] xl:top-[-98px]"><img src="<?= THEME_URL ?>/images/sb_ttls.webp" alt=""></p>
            <p data-aos="fade-up" class="slogan flex justify-between font-bold text-3xl sm:text-5xl lg:text-6xl text-white flex-col w-full mb-[15px] sm:mb-[35px] gap-3.5 tracking-[5px] sm:tracking-[8px] lg:tracking-[12.2px]">
                <span class="text-left text-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">地域の健康を</span>
                <span class="text-right xl:mr-[-17px] text-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">支える仕事を</span>
            </p>
            <a data-aos="fade-up" href="#" class="w-full md:w-[560px] h-auto md:h-[84px] py-4 md:py-0 flex items-center justify-center text-md sm:text-xl md:text-2xl text-white bg-[var(--color-green)] rounded-full gap-2">
                <span class="tracking-[1px] sm:tracking-[2.5px]">お問い合わせフォーム</span>
                <img src="<?= THEME_URL ?>/images/icon-arrow.webp" alt="">
            </a>
        </div>
         <img class="w-full !h-[500px] md:!h-[600px] xl:!h-[700px] object-cover object-center duration-300 ease-in-out" src="<?= THEME_URL ?>/images/hd_bg.webp" alt="">
    </section>
    ...
    <section class="content-section section-white pt-10 pb-5 md:py-[80px] bg-[#FEEEE9]">
        <div class="container-responsive">
            ...
            <div class="max-w-[760px] aspect-video bg-[#d9d9d9] mx-auto mt-[31px]"></div>
        </div>
    </section>
    ...
    <section class="content-section pt-10 pb-5 md:py-[80px] bg-cover bg-full" style="background-image: url(<?= THEME_URL ?>/images/reason_bg.webp)">
        <div class="container-responsive">
            ...
            <div class="flex flex-wrap gap-x-[20px] md:gap-x-[30px] gap-y-[48px] justify-center mt-[54px]">
                <div class="relative flex flex-col items-center justify-start bg-white rounded-[8px] px-[20px] py-[20px] pb-[26px] max-w-[340px] sm:max-w-[calc(50%-10px)] md:max-w-[340px] w-full">
            ...
            <div class="text-center flex justify-center gap-5 md:gap-10 mt-[40px] flex-col sm:flex-row ">
    ...
    <section class="content-section section-white pt-10 lg:pt-0">
        <div class="container-responsive !max-w-full !px-0">
            <div class="flex flex-col lg:flex-row justify-end items-center">
                <div class="bg-white rounded-[8px] max-w-[calc(100%-40px)] lg:max-w-[600px] 2xl:max-w-[700px] w-full pl-[20px] lg:pl-[50px] lg:pr-[50px] py-[50px] mb-[-50px] lg:mb-0 lg:mr-[-301px] relative z-1 lg:pb-[37px] text-center lg:text-left">
            ...
            <div class="flex flex-col justify-end lg:flex-row-reverse items-center mt-[45px]">
                <div class="bg-white rounded-[8px] max-w-[calc(100%-40px)] lg:max-w-[700px] w-full px-[20px] lg:px-[50px] mb-[-50px] lg:mb-0 pt-[20px] xl:pt-[54px] pb-[20px] xl:pb-[34px] lg:ml-[-300px] relative z-1 text-center lg:text-left">
                    <h3 class="text-[26px] md:text-[40px] font-bold text-[var(--color-orange)] tracking-[4px] my-0 mt-1">
                        <span>経験者優遇</span><br>
    ...
    <section class="content-section pt-10 pb-5 md:py-20 bg-[#FEEEE9]">
        <div class="container-responsive">
            <div class="flex flex-col lg:flex-row justify-between items-start">
                <h3 class="text-[26px] md:text-[40px] tracking-[4px] text-[var(--color-orange)] mt-[1px] font-bold">募集要項</h3>
                <div class="lg:max-w-[800px] bg-white w-full rounded-[8px] px-[15px] sm:px-[38px] py-15px sm:pt-[22px] pb-[40px]">
                    <table class="w-full">
                        <tbody>
...
<!--                                px-5 pt-[20px] pb-[24px] tracking-[0.8px] border-b border-[#C7C7C7]-->
    ...
    <section class="content-section section-peach pt-[50px] pb-[50px] relative before:content-[''] before:w-full before:h-[20%] md:before:h-[397px] before:bottom-0 before:left-0 before:bg-[#FEEEE9] before:absolute before:z-[-1]">
        <div class="container-responsive">
            ...
            <div class=" flex flex-wrap justify-center gap-x-[20px] lg:gap-x-[70px] gap-y-[40px] mx-auto mt-[35px]">
                <div class="max-w-[calc(50%-10px)] md:max-w-[300px]">
    ...
    <section class="content-section section-white py-[126px] pb-[128px] bg-left bg-cover" style="background-image: url('<?= THEME_URL ?>/images/sec_08.webp');">
        <div class="container-responsive text-right">
            <div class="inline-block w-full sm:w-[500px] xl:w-[600px] 2xl:w-[700px] bg-white rounded-[8px] px-[20px] py-[20px] md:px-[30px] md:py-[30px] 2xl:px-[50px] 2xl:pt-[56px] 2xl:pb-[34px] text-left">
    ...
    <section class="content-section py-10 md:py-20 md:pb-[75px] bg-[#FEEEE9]">
        <div class="container-responsive">
            <div class="w-full flex flex-wrap justify-between gap-8 items-start">
                <h3 class="text-[26px] md:text-[40px] tracking-[4px] text-[var(--color-orange)] mt-[1px] font-bold">会社概要</h3>

                <div class="w-full lg:max-w-[800px]">
                    <div class="bg-white w-full rounded-[8px] px-[38px] py-[22px] pb-[40px]">
                        <table class="w-full">
                            <tbody>
                    ...
                    <div class="mt-[50px] max-w-full lg:max-w-[800px]">
