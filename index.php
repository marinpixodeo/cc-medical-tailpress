...
<div id="content" class="site-content">
        ...
        <div class="container-responsive !max-w-full !px-0">
            <div class="flex justify-end items-center">
                <div class="bg-white rounded-[8px] max-w-[700px] w-full px-[50px] py-[50px] mr-[-301px] relative z-1 pb-[37px]">
                    <h3 class="text-[40px] font-bold text-[var(--color-orange)] tracking-[4px] my-0 mt-1">
    ...
    <section class="content-section py-20 bg-[#FEEEE9]">
        <div class="container-responsive">
            <div class="flex flex-wrap justify-between gap-8 items-start">
                <h3 class="text-[40px] tracking-[4px] text-[var(--color-orange)] mt-[1px] font-bold">
                    募集要項
                </h3>
    ...
    <section id="inquiry-form" class="content-section section-peach pt-[82px] pb-[16px]">
        <div class="container-responsive">
    ...
    <section class="content-section py-20 pb-[75px] bg-[#FEEEE9]">
        <div class="container-responsive">
            <div class="flex flex-wrap justify-between gap-8 items-start">
                <h3 class="text-[40px] tracking-[4px] text-[var(--color-orange)] mt-[1px] font-bold">
                    会社概要
                ...
                <div class="max-w-[800px]">
                    ...
                    <div class="mt-[50px]">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6000!2d136.98896710737566!3d35.203360104066476!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60036fc5e7fcc54d%3A0x6d765d74cc68a93a!2z5pel5pys44CB44CSNDYzLTAwMjEg5oSb55-l55yM5ZCN5Y-k5bGL5biC5a6I5bGx5Yy65aSn5qOu77yR5LiB55uu77yS77yR77yR77yU!5e0!3m2!1sja!2sus!4v1755771893723!5m2!1sja!2sus"
